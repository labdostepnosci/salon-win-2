    ...
    <div class="container">
        ...
        <div class="footer-top">
            ...
            <div class="footer-brand">
                ...
                <p>
                    <?php esc_html_e( 'Butikowy salon winiarski w Jaśle: restauracja, kameralny hotel, degustacje, wesela, wydarzenia i wyjazdy po dziedzictwie regionu.', 'salon-win' ); ?>
                </p>
            ...
            <div class="footer-col">
                ...
                <ul>
                    ...
                    <li><a href="<?php echo esc_url( home_url( '/#pobyt' ) ); ?>"><?php esc_html_e( 'Pobyt i doświadczenia', 'salon-win' ); ?></a></li>
                    <li><a href="<?php echo esc_url( home_url( '/degustacje' ) ); ?>"><?php esc_html_e( 'Wydarzenia', 'salon-win' ); ?></a></li>
                    <li><a href="<?php echo esc_url( home_url( '/#okolica' ) ); ?>"><?php esc_html_e( 'Atrakcje okolicy', 'salon-win' ); ?></a></li>
